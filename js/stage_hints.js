...
const STAGE_HINTS = {
  ...
  swap_weapon:     { zh: '✓ 首擊 — 敵人會掉武器,踩上去讀條就換槍',
                     en: '✓ FIRST KILL — enemies drop their gun; stand on it to swap' },
  ...
  build_mode:      { zh: 'B 開建造輪盤 · 防禦/武裝模塊邊建邊打',
                     en: 'B opens the build radial · defense + offense modules on the fly' },
  ...
  unlock_defense:  { zh: '★ 解鎖 DEFENSE — 邊建造邊抵禦,防禦/武裝模塊任選',
                     en: '★ DEFENSE unlocked — build while you fight, defense + offense modules' },
